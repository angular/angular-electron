...
import {ElectronMessageBus} from './message_bus';
...
export class ClientMessageBrokerFactory_ extends ClientMessageBrokerFactory {
  ...
  constructor(private _messageBus: ElectronMessageBus, _serializer: Serializer) {
    super();
...
export class ClientMessageBroker_ extends ClientMessageBroker {
  ...
  constructor(
      messageBus: ElectronMessageBus, _serializer: Serializer, public channel: any /** TODO #9100 */) {
    super();
  ...
  private _generateMessageId(name: string): string {
    ...
    let id: string = name + time + iteration;
    while (((this as any /** TODO #9100 */)._pending[id])) {
